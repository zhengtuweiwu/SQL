...
if __name__ == '__main__':
    ...
    saver.save(sess, "model\\LSTM\\sql-cnn-" + str(sqlLength) + "\\sql-cnn-" + str(sqlLength))
    ###########以下为现场测试
    ...
    with tf.Session() as sess_test:
        new_saver = tf.train.import_meta_graph(
            "model\\LSTM\\sql-cnn-" + str(sqlLength) + "\\sql-cnn-" + str(sqlLength) + ".meta")
        new_saver.restore(sess_test, tf.train.latest_checkpoint("model\\LSTM\\sql-cnn-" + str(sqlLength)))
