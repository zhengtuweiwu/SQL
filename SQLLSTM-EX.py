...
if __name__ == '__main__':
    ...
    saver.save(sess, "model\\LSTM\\NO-FFT\\"+str(hidden_size)+"port\\sql-ex-cnn-" + str(sqlLength) + "\\sql-ex-cnn-" + str(sqlLength))
    ###########以下为现场测试
    ...
    with tf.Session() as sess_test:
        new_saver = tf.train.import_meta_graph(
            "model\\LSTM\\NO-FFT\\"+str(hidden_size)+"port\\sql-ex-cnn-" + str(sqlLength) + "\\sql-ex-cnn-" + str(sqlLength) + ".meta")
        new_saver.restore(sess_test, tf.train.latest_checkpoint("model\\LSTM\\NO-FFT\\"+str(hidden_size)+"port\\sql-ex-cnn-" + str(sqlLength)))
